...
public class YuyueguanliController {
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,YuyueguanliEntity yuyueguanli, 
    ...
    public R query(YuyueguanliEntity yuyueguanli){
		...
		return R.ok("查询预约管理成功").put("data", yuyueguanliView);
    }
    ...
    public R save(@RequestBody YuyueguanliEntity yuyueguanli, HttpServletRequest request){
    	...
    	//ValidatorUtils.validateEntity(yuyueguanli);
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YuyueguanliEntity> wrapper = new EntityWrapper<YuyueguanliEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yuyueguanliService.selectCount(wrapper);
