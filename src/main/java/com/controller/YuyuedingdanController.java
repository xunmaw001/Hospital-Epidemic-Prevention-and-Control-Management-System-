...
public class YuyuedingdanController {
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,YuyuedingdanEntity yuyuedingdan, HttpServletRequest request){
        EntityWrapper<YuyuedingdanEntity> ew = new EntityWrapper<YuyuedingdanEntity>();
		PageUtils page = yuyuedingdanService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, yuyuedingdan), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<YuyuedingdanEntity> wrapper = new EntityWrapper<YuyuedingdanEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = yuyuedingdanService.selectCount(wrapper);
