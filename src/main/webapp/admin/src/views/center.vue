     ...
     <el-row>
        ...
        <el-form-item   v-if="flag=='yisheng'"  label="工号" prop="gonghao">
          <el-input v-model="ruleForm.gonghao" readonly              placeholder="工号" clearable></el-input>
                                          ...
                                          <el-col :span="12">
        <el-form-item   v-if="flag=='yisheng'"  label="医生名" prop="yishengming">
          <el-input v-model="ruleForm.yishengming"               placeholder="医生名" clearable></el-input>
        </el-form-item>
      </el-col>
                        <el-col :span="12">
        ...
        <el-form-item   v-if="flag=='yisheng'"  label="工作经历" prop="gongzuojingli">
          <el-input v-model="ruleForm.gongzuojingli"               placeholder="工作经历" clearable></el-input>
                        ...
                        <el-col :span="12">
        <el-form-item v-if="flag=='yisheng'"  label="文化程度" prop="wenhuachengdu">
          <el-select v-model="ruleForm.wenhuachengdu" placeholder="请选择文化程度">
            <el-option
                v-for="(item,index) in yishengwenhuachengduOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
...
export default {
    ...
    this.$http({
      ...
      if (data && data.code === 0) {
        ...
        this.$message.error(data.msg);
                                                ...
                                                this.yishengwenhuachengduOptions = "博士,硕士,本科,专科,高中,初中".split(',')
  ...
  methods: {
        ...
        return
                                                                  ...
                                                                  if((!this.ruleForm.yishengming)&& 'yisheng'==this.flag){
