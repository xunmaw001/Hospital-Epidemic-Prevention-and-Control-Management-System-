<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="报告时间" prop="baogaoshijian">
          <el-input v-model="ruleForm.baogaoshijian" 
              placeholder="报告时间" clearable  :readonly="ro.baogaoshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="报告时间" prop="baogaoshijian">
              <el-input v-model="ruleForm.baogaoshijian" 
                placeholder="报告时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="身体异常" prop="shentiyichang">
          <el-select v-model="ruleForm.shentiyichang" placeholder="请选择身体异常">
            <el-option
                v-for="(item,index) in shentiyichangOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="身体异常" prop="shentiyichang">
	      <el-input v-model="ruleForm.shentiyichang"
                placeholder="身体异常" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.baogaoshijian = true;
            continue;
	            	            ...
	            	            if(o=='shentiyichang'){
            this.ruleForm.shentiyichang = obj[o];
	    this.ro.shentiyichang = true;
            continue;
          }
	            	            if(o=='yonghuming'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                            ...
                                                            this.shentiyichangOptions = "无,有".split(',')
                                        this.$http({
