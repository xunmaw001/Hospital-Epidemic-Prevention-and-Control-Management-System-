<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
                        <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="预约医生" prop="yuyueyisheng">
          <el-select  @change="yuyueyishengChange" v-model="ruleForm.yuyueyisheng" placeholder="请选择预约医生">
            <el-option
                v-for="(item,index) in yuyueyishengOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.yuyueyisheng" label="预约医生" prop="yuyueyisheng">
              <el-input v-model="ruleForm.yuyueyisheng" 
                placeholder="预约医生" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" label="挂号费" prop="guahaofei">
              <el-input v-model="ruleForm.guahaofei" 
                placeholder="挂号费" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="挂号科室" prop="guahaokeshi">
          <el-input v-model="ruleForm.guahaokeshi" 
              placeholder="挂号科室" clearable  :readonly="ro.guahaokeshi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="挂号科室" prop="guahaokeshi">
              <el-input v-model="ruleForm.guahaokeshi" 
                placeholder="挂号科室" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
          ...
          <el-form-item class="input" v-if="ruleForm.guahaoshijian" label="挂号时间" prop="guahaoshijian">
              <el-input v-model="ruleForm.guahaoshijian" 
                placeholder="挂号时间" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="单号" prop="danhao">
          <el-input v-model="ruleForm.danhao" 
              placeholder="单号" clearable  :readonly="ro.danhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="单号" prop="danhao">
              <el-input v-model="ruleForm.danhao" 
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          	            if(o=='yuyueyisheng'){
            this.ruleForm.yuyueyisheng = obj[o];
	    this.ro.yuyueyisheng = true;
            continue;
          }
	            	            if(o=='guahaofei'){
	    ...
	    this.ro.guahaofei = true;
            continue;
	            	            ...
	            	            if(o=='guahaokeshi'){
            this.ruleForm.guahaokeshi = obj[o];
	    this.ro.guahaokeshi = true;
            continue;
          }
	            	            if(o=='guahaoshijian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                this.yuyueyishengOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
    ...
    yuyueyishengChange () {
      this.$http({
        url: `follow/yisheng/yishengming?columnValue=`+ this.ruleForm.yuyueyisheng,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
                                                                                                                                } else {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `yuyuedingdan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yuyuedingdanCrossAddOrUpdateFlag = false;
                  this.parent.search();
