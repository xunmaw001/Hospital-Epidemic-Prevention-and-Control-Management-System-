          ...
          <el-form-item class="input" label="密码" prop="mima">
              <el-input v-model="ruleForm.mima" 
                placeholder="密码" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="医生名" prop="yishengming">
          <el-input v-model="ruleForm.yishengming" 
              placeholder="医生名" clearable  :readonly="ro.yishengming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="医生名" prop="yishengming">
              <el-input v-model="ruleForm.yishengming" 
          ...
          <el-form-item class="input" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="身份证" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="文化程度" prop="wenhuachengdu">
          <el-select v-model="ruleForm.wenhuachengdu" placeholder="请选择文化程度">
            <el-option
                v-for="(item,index) in wenhuachengduOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
  ...
  data() {
	...
	zhaopian : false,
            ...
            ruleForm: {
                  ...
                  yishengming: [
                            { required: true, message: '医生名不能为空', trigger: 'blur' },
                                    	                                                              ],
                  xingbie: [
                                    	                                                              ],
                  shouji: [
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                ...
                                                                                                this.xingbieOptions = "男,女".split(',')
                                                                                                                this.wenhuachengduOptions = "博士,硕士,本科,专科,高中,初中".split(',')
                                              },
                                                                                        // 多级联动参数
                                                                                                                info(id) {
      this.$http({
