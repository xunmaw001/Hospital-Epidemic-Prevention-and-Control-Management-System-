          ...
          <el-form-item class="input" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="身份证" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="现所在地" prop="xiansuozaidi">
          <el-input v-model="ruleForm.xiansuozaidi" 
              placeholder="现所在地" clearable  :readonly="ro.xiansuozaidi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="现所在地" prop="xiansuozaidi">
              <el-input v-model="ruleForm.xiansuozaidi" 
                placeholder="现所在地" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
                                      <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="行动轨迹" prop="xingdongguiji">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.xingdongguiji" label="行动轨迹" prop="xingdongguiji">
                    <span>{{ruleForm.xingdongguiji}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shenfenzheng = true;
            continue;
	            	            ...
	            	            if(o=='xiansuozaidi'){
            this.ruleForm.xiansuozaidi = obj[o];
	    this.ro.xiansuozaidi = true;
            continue;
          }
	                    }
                                                                                                              }
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `fangyibaobei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.fangyibaobeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
