  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="公告类型" prop="gonggaoleixing">
              <el-input v-model="ruleForm.gonggaoleixing" 
                placeholder="公告类型" readonly></el-input>
                                                                  ...
                                                                  <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="公告状态" prop="gonggaozhuangtai">
          <el-select v-model="ruleForm.gonggaozhuangtai" placeholder="请选择公告状态">
            <el-option
                v-for="(item,index) in gonggaozhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="公告状态" prop="gonggaozhuangtai">
	      <el-input v-model="ruleForm.gonggaozhuangtai"
                placeholder="公告状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.gonggaoneirong = true;
            continue;
	            	            ...
	            	            if(o=='gonggaozhuangtai'){
            this.ruleForm.gonggaozhuangtai = obj[o];
	    this.ro.gonggaozhuangtai = true;
            continue;
          }
	            	            if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
                                                                                                                  ...
                                                                                                                  this.gonggaozhuangtaiOptions = "最近三天发布,最近一周发布,最近一个月发布".split(',')
                                              },
                                                        // 多级联动参数
                                                                        info(id) {
      this.$http({
